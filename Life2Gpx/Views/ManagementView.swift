        ...
        NavigationView {
            List {
                ...
                Section(header: Text("Customization")) {
                    NavigationLink(destination: SettingsCategoryIconsView()) {
                        Text("Category items")
                    }
                    NavigationLink(destination: SettingsTrackTypesView()) {
                        Text("Track types")
                    }
                    NavigationLink(destination: SettingsActivityRulesView()) {
